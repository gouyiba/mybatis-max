 ...
 **/
public class RabbitMapperAnnotationBuilder extends MapperAnnotationBuilder {
    ...
    public RabbitMapperAnnotationBuilder(RabbitConfiguration configuration, Class<?> type) {
