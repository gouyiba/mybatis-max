...
/**
 * this class by created wuyongfei on 2020/5/5 20:03
 **/
public class MybatisMaxMapperAnnotationBuilder extends MapperAnnotationBuilder {
    private static final Set<Class<? extends Annotation>> SQL_ANNOTATION_TYPES = new HashSet();
    private static final Set<Class<? extends Annotation>> SQL_PROVIDER_ANNOTATION_TYPES = new HashSet();
    private final MybatisMaxConfiguration configuration;
    private final MapperBuilderAssistant assistant;
    private final Class<?> type;

    public MybatisMaxMapperAnnotationBuilder(MybatisMaxConfiguration configuration, Class<?> type) {
    ...
    public void parse() {
        ...
        if (!this.configuration.isResourceLoaded(resource)) {
            ...
            if (MybatisMaxConfigUtils.isSupperMapperChildren(this.configuration, this.type)) {
                MybatisMaxConfigUtils.getSqlInjector(this.configuration).inspectInject(this.assistant, this.type);
            }
        }
