 ...
 **/
public class MybatisMaxXMLConfigBuilder extends BaseBuilder {
    private final XPathParser parser;
    private final ReflectorFactory localReflectorFactory;
    private boolean parsed;
    private String environment;

    public MybatisMaxXMLConfigBuilder(Reader reader) {
        this((Reader) reader, (String) null, (Properties) null);
    }

    public MybatisMaxXMLConfigBuilder(Reader reader, String environment) {
        this((Reader) reader, environment, (Properties) null);
    }

    public MybatisMaxXMLConfigBuilder(Reader reader, String environment, Properties props) {
        this(new XPathParser(reader, true, props, new XMLMapperEntityResolver()), environment, props);
    }

    public MybatisMaxXMLConfigBuilder(InputStream inputStream) {
        this((InputStream) inputStream, (String) null, (Properties) null);
    }

    public MybatisMaxXMLConfigBuilder(InputStream inputStream, String environment) {
        this((InputStream) inputStream, environment, (Properties) null);
    }

    public MybatisMaxXMLConfigBuilder(InputStream inputStream, String environment, Properties props) {
        this(new XPathParser(inputStream, true, props, new XMLMapperEntityResolver()), environment, props);
    }

    private MybatisMaxXMLConfigBuilder(XPathParser parser, String environment, Properties props) {
        super(new MybatisMaxConfiguration());
    ...
    public MybatisMaxConfiguration getConfiguration() {
        return (MybatisMaxConfiguration) this.configuration;
    }
