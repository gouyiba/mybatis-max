...
public final class ClassUtils {
    ...
    public static <T> T newInstance(Class<T> clazz) {
        try {
            ...
            throw new MyBatisMaxException(String.format("实例化对象时出现错误,请尝试给 %s 添加无参的构造方法",clazz.getName()));
        }
    }
    ...
    public static Class<?> toClassConfident(String name) {
        try {
            ...
            throw new MyBatisMaxException("找不到指定的class！请仅在明确确定会有 class 的时候，调用该方法");
        }
    }
